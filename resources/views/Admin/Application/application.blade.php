    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Application Datatable</h3>
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-end">
                    <a href="{{ route('createApplication') }}" class="btn btn-rounded btn-primary pl-3 pr-3">Add Application</a>
                </div>
            </div>
        </div>
    </div>
