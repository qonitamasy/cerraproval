    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Invoice Datatable</h3>
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-end">
                    <a href="{{ route('createInvoice') }}" class="btn btn-rounded btn-primary pl-3 pr-3">Add Invoice</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table id="myTable" class="table table-striped table-bordered text-nowrap table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('destroyInvoice',$item->id) }}" method="POST" style="display: flex; justify-content:center">
                                                <a class="btn btn-primary" href="{{ route('editInvoice', $item->id) }}">Edit</a>
                                                @csrf
                                                @method('DELETE')
